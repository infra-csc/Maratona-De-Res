    ...
    return (
      <div style={shellStyle} className="min-h-screen flex items-center justify-center p-6">
        <Card className="max-w-md w-full p-8 text-center">
          ...
          <p className="text-sm" style={{ color: "var(--muted-foreground)" }}>Este link já foi respondido por <strong style={{ color: "var(--foreground)" }}>{info.submitterName ?? "alguém"}</strong>. Obrigado!</p>
        </Card>
      </div>
    );
  }
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        <Card className="px-6 pt-6 pb-7">
          <div className="flex items-center gap-2 mb-4">
            {isConformity ? <ShieldAlert size={14} strokeWidth={2.5} style={{ color: "var(--accent)" }} /> : <ClipboardCheck size={14} strokeWidth={2.5} style={{ color: "var(--accent)" }} />}
