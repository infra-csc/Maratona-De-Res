...
- [Router mount order RBAC trap](router-mount-order.md) — read routers needed by non-admin roles must mount BEFORE audit/integration (blanket requireRole admin|rh) or fall-through 403s them
