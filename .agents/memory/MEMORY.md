...
- [Historical results import](historical-results-import.md) — pre-calibrated events (isHistorical+importedScore) bypass computeEventTeamResult everywhere; bulk import needs dry-run/create/update/conflict pattern
