...
- [Consolidation/payments detail modal](results-detail-modal.md) — EmployeeDetailSheet shared component (reused by all tabs) for ranking detail; sortable column headers with SortIcon on consolidation and payments tables
