...
export const GetEventsResponseItem = zod.object({
  ...
  "evaluatedCriteria": zod.number().optional().describe('Nº de critérios ativos já avaliados (ou calibrados) neste evento.'),
  "totalEvaluatorSlots": zod.number().optional().describe('Soma de avaliadores designados por critério ativo (pai + eventScoped). Denominador correto para barra de avaliações.'),
  "submittedEvaluatorCount": zod.number().optional().describe('Soma de avaliadores que já submeteram por critério ativo. Numerador para barra de avaliações.'),
  "calibratedCriteriaCount": zod.number().optional().describe('Nº de critérios ativos com calibração salva (score preenchido, independente de publicação de feedback).'),
  "finalCalibratedCriteria": zod.number().optional().describe('Nº de critérios ativos com calibração final publicada.'),
  "partialPublishedCount": zod.number().optional().describe('Nº de critérios ativos com pelo menos uma publicação parcial.'),
